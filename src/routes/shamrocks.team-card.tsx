...
export const Route = createFileRoute("/shamrocks/team-card")({
  head: () => ({
    meta: [
      { title: "Team Card — Springfield Shamrocks × FanPact" },
...
function Done({ store, onReset }: { store: typeof STORES["shamrocks"]; onReset: () => void }) {
  return (
