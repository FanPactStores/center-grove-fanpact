...
export const Route = createFileRoute("/missouri/checkout-confirmation")({
  head: () => ({ meta: [{ title: "Order confirmation — Missouri × FanPact" }] }),
    ...
    <main className="mx-auto max-w-3xl px-4 py-16 lg:px-8">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        <Button asChild variant="outline">
          <Link to="/missouri">Back to store</Link>
        </Button>
      </div>
    </main>
  );
