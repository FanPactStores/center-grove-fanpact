...
export const Route = createFileRoute("/cause/west-side-christian-church/product/$slug")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => ({
    meta: [
      {
        title: `${loaderData?.product.name ?? "Product"} — West Side Christian Church × FanPact`,
      },
        ...
        <div>
          ...
          <div className="mt-8 flex items-center gap-3">
            ...
            <Button size="lg" className="flex-1 gap-2" asChild>
              <Link to="/cause/west-side-christian-church/cart">
