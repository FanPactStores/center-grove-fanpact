...
export const Route = createFileRoute("/missouri/shop/")({
  validateSearch: (search: Record<string, unknown>): ShopSearch => ({
    search: typeof search.search === "string" && search.search ? search.search : undefined,
  }),
  head: () => ({
    meta: [
      { title: "Shop — Missouri × FanPact" },
      { name: "description", content: "Browse every product. 60% of net earnings flows to Mizzou Athletics." },
    ],
  }),
  component: MissouriShop,
});

function MissouriShop() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
      <div className="mb-8">
        ...
        <h1 className="mt-2 font-display text-5xl tracking-tight">The Missouri store</h1>
      </div>
      <div className="mb-8">
