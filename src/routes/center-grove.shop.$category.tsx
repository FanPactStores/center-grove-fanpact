...
export const Route = createFileRoute("/center-grove/shop/$category")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: `${loaderData?.category.name ?? "Category"} — Center Grove × FanPact` },
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-24 text-center lg:px-8">
      ...
      <p className="mt-3 text-muted-foreground">
        That category doesn't exist in the Center Grove store.
      </p>
      <Link to="/center-grove/shop" className="mt-6 inline-block text-sm underline">
    ...
    <main className="bg-background">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs text-muted-foreground">
          <Link to="/center-grove" className="hover:text-foreground">
            Store
          </Link>
