...
export const Route = createFileRoute("/butler/cart")({
  head: () => ({ meta: [{ title: "Cart — Butler × FanPact" }] }),
    ...
    <main className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
      ...
      {items.length === 0 ? (
        <div className="mt-12 rounded-xl border border-dashed border-border p-12 text-center">
          ...
          <Button asChild className="mt-4"><Link to="/butler/shop">Browse the store</Link></Button>
        </div>
      ) : (
