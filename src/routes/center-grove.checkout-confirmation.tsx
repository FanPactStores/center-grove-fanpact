...
export const Route = createFileRoute("/center-grove/checkout-confirmation")({
  head: () => ({ meta: [{ title: "Order confirmation — Center Grove × FanPact" }] }),
    ...
    <main className="mx-auto max-w-3xl px-4 py-16 lg:px-8">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        <Button asChild variant="outline">
          <Link to="/center-grove">Back to store</Link>
        </Button>
      </div>
    </main>
  );
