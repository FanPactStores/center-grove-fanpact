...
export const Route = createFileRoute("/shamrocks/shop/$category")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: `${loaderData?.category.name ?? "Category"} — Springfield Shamrocks × FanPact` },
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-24 text-center lg:px-8">
      ...
      <p className="mt-3 text-muted-foreground">
        That category doesn't exist in the Springfield Shamrocks store.
      </p>
      <Link to="/shamrocks/shop" className="mt-6 inline-block text-sm underline">
    ...
    <main className="bg-background">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs text-muted-foreground">
          <Link to="/shamrocks" className="hover:text-foreground">
            Store
          </Link>
