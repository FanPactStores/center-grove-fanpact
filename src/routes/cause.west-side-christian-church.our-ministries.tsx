...
export const Route = createFileRoute("/cause/west-side-christian-church/our-ministries")({
  head: () => ({
    meta: [
      { title: "Our Hospital — West Side Christian Church × FanPact" },
      {
        name: "description",
        content:
          "West Side Christian Church in Springfield, Illinois serves families across central and southern Illinois with comprehensive pediatric care.",
      },
      { property: "og:title", content: "Our Hospital — West Side Christian Church" },
      {
    ...
    <main>
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 lg:px-8">
        <p className="text-lg leading-relaxed text-muted-foreground">
          West Side Christian Church'serves families throughout central and southern
